...
void GWorldInit(void)
{
	...
	if (NewGWorld( &gmaps, 1, &itemRect, 0L, 0L, 0L )) scratch2(2);/*** could not create gworld ****/
	SetGWorld( gmaps, NIL );
	...
	if (NewGWorld( &gedge, 8, &itemRect, 0L, 0L, 0L )) scratch2(2);/*** could not create gworld ****/
	SetGWorld( gedge, NIL );
	PenSize(3,3);
	ForeColor(blackColor);
	BackColor(whiteColor);
	...
	if (NewGWorld( &gbuff, 8, &itemRect, 0L, 0L, 0L )) scratch2(2);/*** could not create gworld ****/
	SetGWorld( gbuff, NIL );
	ForeColor( blackColor );
	BackColor( whiteColor );
	...
	if (NewGWorld( &gbuff2, 8, &itemRect, 0L, 0L, 0L )) scratch2(2);/*** could not create gworld ****/
	...
	if (NewGWorld( &gthePixels, 8, &itemRect, 0L, 0L, 0L )) scratch2(2);/*** could not create gworld ****/
	...
	aire=((**picture).picFrame);
	if (NewGWorld( &gBackWorld, 8, &aire, 0L, 0L, 0L )) scratch2(2);/*** could not create gworld ****/
	...
	/******************** floor PICT ********/
	if (NewGWorld( &gFloorWorld, 8, &aire, 0L, 0L, 0L )) scratch2(2);/*** could not create gworld ****/
	...
	if (NewGWorld( &gHWallsWorld, 8, &aire, 0L, 0L, 0L )) scratch2(2);/*** could not create gworld ****/
	...
	if (NewGWorld( &gVWallsWorld, 8, &aire, 0L, 0L, 0L )) scratch2(2);/*** could not create gworld ****/
	...
	if (NewGWorld( &gPillarsWorld, 8, &aire, 0L, 0L, 0L )) scratch2(2);/*** could not create gworld ****/
