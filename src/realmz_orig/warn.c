...
void warn(short string)
{
 ...
 if (look) SetPort(GetWindowPort(screen));

 if (inswap) SetPortDialogPort(gswap);
 else if (inbooty) SetPort(GetWindowPort(bootywindow));
  else if (initems) SetPort(GetWindowPort(itemswindow));
   else if (inshop) SetPort(GetWindowPort(gshop));
    else if (intemple) SetPortDialogPort(templewindow);
     else if (spellwindow) SetPortDialogPort(spellwindow);
      else if (inscroll) SetPortDialogPort(scroll);
       else if (background) SetPortDialogPort(background);
        else if (about) SetPortDialogPort(about);
         else if (screen) SetPort(GetWindowPort(screen));
