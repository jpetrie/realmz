...
- `VERBOSE=1 cmake --fresh -B build -D CMAKE_BUILD_TYPE=Debug -D CMAKE_VERBOSE_MAKEFILE:BOOL=ON -DSDLTTF_VENDORED=ON -DDISABLE_SDL:BOOL=ON -DCMAKE_OSX_DEPLOYMENT_TARGET=13.3`
